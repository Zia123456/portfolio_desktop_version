...
# Zia's Portfolio <a name="Zia's Portfolio"></a>

This portfolio is designed to exhibit my competencies and proficiencies to potential employers.
...
- [live Demo] ( https://zia123456.github.io/portfolio_desktop_version/)
...
```
  git clone https://github.com/Zia123456/portfolio_desktop_version.git
```

open the repo find index.html, open it by any browser.
